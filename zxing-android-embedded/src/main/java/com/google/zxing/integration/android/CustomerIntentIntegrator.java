...
public class CustomerIntentIntegrator {

    public static final int REQUEST_CODE = 0x0000c0de; // Only use bottom 16 bits
    private static final String TAG = CustomerIntentIntegrator.class.getSimpleName();
     ...
     */
    public CustomerIntentIntegrator(Activity activity) {
     ...
     */
    public CustomerIntentIntegrator setCaptureActivity(Class<?> captureActivity) {
    ...
    public final CustomerIntentIntegrator addExtra(String key, Object value) {
     ...
     */
    public final CustomerIntentIntegrator setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public CustomerIntentIntegrator setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public CustomerIntentIntegrator setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public CustomerIntentIntegrator setBeepEnabled(boolean enabled) {
     ...
     * @return this
     */
    public CustomerIntentIntegrator setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public CustomerIntentIntegrator setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     */
    public static CustomerIntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                return new CustomerIntentResult(contents,
                        formatName,
                        rawBytes,
                        orientation,
            ...
            return new CustomerIntentResult();
        }
        return null;
    }
