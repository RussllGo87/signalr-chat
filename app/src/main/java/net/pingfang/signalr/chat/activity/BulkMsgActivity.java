...
public class BulkMsgActivity extends AppCompatActivity implements View.OnClickListener, OnDialogListItemListener {
    ...
    private void inflaterTxtMessage(String nameFrom, boolean direction, String content, String datetime) {
        ...
        //        if(direction) {
        //            params.setMargins(MediaFileUtils.dpToPx(getApplicationContext(), 16), 0, 0, 0);
        //        } else {
        //            params.setMargins(0, 0, MediaFileUtils.dpToPx(getApplicationContext(), 16), 0);
        //        }
        ...
        //        tv_msg.setPadding(MediaFileUtils.dpToPx(getApplicationContext(), 16), MediaFileUtils.dpToPx(getApplicationContext(), 16),
        //                MediaFileUtils.dpToPx(getApplicationContext(), 16), MediaFileUtils.dpToPx(getApplicationContext(), 16));
        //        if(direction) {
