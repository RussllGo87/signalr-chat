...
public class PwdForgetActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static final String URL_LOAD_VALIDATE_CODE = GlobalApplication.URL_WEB_API_HOST + "/api/getValidateCode";
    public static final String KEY_LOAD_VALIDATE_CODE_ACCOUNT_PHONE = "phone";

    public static final String URL_PWD_FORGET = GlobalApplication.URL_WEB_API_HOST + "/api/forgetPwd";
    public static final String KEY_PWD_FORGET_ACCOUNT_PHONE = "phone";
    public static final String KEY_PWD_FORGET_VCODE = "vcode";
    public static final String KEY_PWD_FORGET_PASSWORD_NEW = "password";
